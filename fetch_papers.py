...
if __name__ == "__main__":
  ...
  parser.add_argument('--num-retries', type=int, default=10, help='Number of times to retry a query')
  ...
  for cat in cats:
    ...
    # TODO: To get more than 50k results, try searching separately for each category in search-query
    # -----------------------------------------------------------------------------
    ...
    for i in range(args.start_index, args.max_index, args.results_per_iteration):
      ...
      if num_added > 0:
        print('Saving database with %d papers to %s' % (len(db), db_path))
